...
typedef enum
{
   ...
   GMCP_SENTIENCE_EDITOR_SET,
   GMCP_SENTIENCE_EDITOR_COMMIT,
   GMCP_SENTIENCE_EDITOR_REVERT,
   GMCP_SENTIENCE_EDITOR_REQUEST,
   GMCP_SENTIENCE_EDITOR_STRING_SAVE,
   GMCP_SENTIENCE_EDITOR_STRING_CANCEL,
   GMCP_SENTIENCE_EDITOR_DRAFT_SAVE,
   GMCP_SENTIENCE_EDITOR_DRAFT_LOAD,
   GMCP_SENTIENCE_EDITOR_ACTION,
   GMCP_SENTIENCE_EDITOR_ACTION_SUBMIT,
   GMCP_RECEIVE_MAX
} GMCP_RECEIVE;
