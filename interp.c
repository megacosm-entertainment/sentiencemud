...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "north",		do_north,	POS_STANDING,    0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "east",		do_east,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "south",		do_south,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "west",		do_west,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "up",			do_up,		POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "down",		do_down,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "northeast",	do_northeast,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "northwest",	do_northwest,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "southeast",	do_southeast,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "southwest",	do_southwest,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "ne",			do_northeast,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "nw",			do_northwest,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "se",			do_southeast,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    { "sw",			do_southwest,	POS_STANDING,	 0,  LOG_NEVER, 0, false, "NORTH EAST SOUTH WEST UP DOWN NORTHWEST NORTHEAST SOUTHEAST SOUTHWEST" },
    ...
    { "auction",    do_auction,     POS_SLEEPING,    0,  LOG_ALWAYS, 1, false, "AUCTION"},
    { "bar",		do_bar,		POS_RESTING,	 0,  LOG_NORMAL, 1, false, "BAR" },
    { "bomb",		do_bomb,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "buy",		do_buy,		POS_RESTING,	 0,  LOG_NORMAL, 1, false, "SHOPS LIST BUY SELL INSPECT VALUE" },
    { "cast",		do_cast,	POS_FIGHTING,	 0,  LOG_NORMAL, 1, false, "CAST" },
    { "channels",   do_channels,    POS_DEAD,        0,  LOG_NORMAL, 1, true, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "danger",		do_danger,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "SENSE DANGER" },
    { "donate",		do_donate,	POS_RESTING,	 0,  LOG_ALWAYS, 1, false },
    { "evasion",	do_evasion,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "exits",		do_exits,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "EXITS" },
    { "fade",		do_fade,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "FADE" },
    { "get",		do_get,		POS_RESTING,	 0,  LOG_NORMAL, 1, false, "GET PUT TAKE" },
    { "goto",       do_goto,        POS_DEAD,       L5,  LOG_ALWAYS, 1, false, "GOTO" },
...
//    { "mapgoto",        do_mapgoto,     POS_DEAD,       L5,  LOG_ALWAYS, 1, false },
    { "group",      do_group,       POS_SLEEPING,    0,  LOG_NORMAL, 1, false, "GROUP" },
    { "hit",		do_kill,	POS_FIGHTING,	 0,  LOG_NORMAL, 0, false },
    { "hold",		do_wear,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "WEAR WIELD HOLD SECONDARY" },
    { "inventory",	do_inventory,	POS_DEAD,	 0,  LOG_NORMAL, 1, false, "INVENTORY EQUIPMENT" },
    { "judge",		do_judge,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "kill",		do_kill,	POS_FIGHTING,	 0,  LOG_NORMAL, 1, false },
    { "look",		do_look,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "LOOK EXAMINE READ" },
    { "music",      do_music,   	POS_SLEEPING,    0,  LOG_NORMAL, 1, false, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "order",		do_order,	POS_RESTING,	 0,  LOG_ALWAYS, 1, false },
    { "practice",   do_practice,	POS_FIGHTING,    0,  LOG_NORMAL, 1, false, "PRACTICE TRAIN" },
    { "pull",       do_pull,	POS_SLEEPING,    0,  LOG_NORMAL, 1, false },
    { "push",       do_push,	POS_SLEEPING,    0,  LOG_NORMAL, 1, false },
    { "quest",      do_quest,       POS_SLEEPING,    0,  LOG_NORMAL, 1, false, "QUESTING" },
    { "rehearse",   do_rehearse,	POS_FIGHTING,    0,  LOG_NORMAL, 1, false },
    { "renew",      do_renew,       POS_RESTING,    0,  LOG_NORMAL, 1, false },
    { "reply",		do_reply,	POS_SLEEPING,	 0,  LOG_NEVER,  1, false, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "rest",		do_rest,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, false, "SLEEP WAKE REST STAND" },
    { "resurrect",	do_resurrect,	POS_SLEEPING,	 0,  LOG_ALWAYS, 1, false, "RESURRECT" },
    { "sit",		do_sit,		POS_SLEEPING,    0,  LOG_NORMAL, 1, false, "SLEEP WAKE REST STAND" },
    { "stand",		do_stand,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, false, "SLEEP WAKE REST STAND" },
    { "stat",		do_stat,	POS_DEAD,	L5,  LOG_NORMAL, 1, false },
    { "tell",		do_tell,	POS_RESTING,     0,  LOG_NEVER,  1, false, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "tells",		do_tells,	POS_SLEEPING,    0,  LOG_NORMAL, 1, false, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "turn",       do_turn,	POS_SLEEPING,    0,  LOG_NORMAL, 1, false },
    { "unlock",     do_unlock,      POS_RESTING,     0,  LOG_NORMAL, 1, false, "LOCK UNLOCK" },
    { "ungroup",	do_ungroup,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "GROUP" },
    { "use",		do_use,		POS_SLEEPING,    0,  LOG_NORMAL, 1, false },
//    { "waypoint",	do_waypoint,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "wield",		do_wear,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "WEAR WIELD HOLD SECONDARY" },
    { "conceal",	do_conceal,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },

    // Informational commands
    { "affects",	do_affects,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "AFFECTS" },
    { "challenge",	do_challenge,	POS_SLEEPING,	 0,  LOG_ALWAYS, 1, false },
    { "changes",	do_changes,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "NOTES" },
    { "commands",	do_commands,	POS_DEAD,	 0,  LOG_NORMAL, 1, true },
    { "consider",	do_consider,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "count",		do_count,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, false, "COUNT" },
    { "credits",	do_credits,	POS_DEAD,	 0,  LOG_NORMAL, 1, true },
    { "dice",		do_dice,	POS_DEAD,	 0,  LOG_NORMAL, 1, false },
    { "equipment",	do_equipment,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "INVENTORY EQUIPMENT" },
    { "examine",	do_examine,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "LOOK EXAMINE READ" },
    { "flag",		do_flag,	POS_RESTING,	 0,  LOG_NORMAL, 1, true },
    { "gold",		do_worth,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, false, "GOLD SILVER" },
    { "help",		do_help,	POS_DEAD,	 0,  LOG_NORMAL, 1, true },
    { "house",	 	do_house,	POS_RESTING,	 0,  LOG_ALWAYS, 1, false },
    { "intimidate",	do_intimidate,	POS_FIGHTING,	 0,  LOG_NORMAL, 1, false, "INTIMIDATE" },
    { "motd",		do_motd,	POS_DEAD,        0,  LOG_NORMAL, 1, true, "MOTD" },
    { "mccp",	 	do_compress,	POS_DEAD,        0,  LOG_NORMAL, 1, true },
    { "news",		do_news,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "NOTES" },
    { "read",		do_look,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "LOOK EXAMINE READ" },
    { "repair",		do_repair,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "report",		do_report,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "SCORE REPORT" },
    { "rules",		do_rules,	POS_DEAD,	 0,  LOG_NORMAL, 1, false, "RULES" },
    { "score",		do_score,	POS_DEAD,	 0,  LOG_NORMAL, 1, false, "SCORE REPORT" },
    { "scry",		do_scry,	POS_DEAD,	 0,  LOG_NORMAL, 1, false, "SCRY" },
    { "skills",		do_skills,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "SKILLS SPELLS" },
    { "socials",	do_socials,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "SOCIALS" },
    { "spells",		do_spells,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "SKILLS SPELLS" },
    { "stats",		do_stats,	POS_DEAD,	 0,  LOG_NORMAL, 1, true },
    { "time",		do_time,	POS_DEAD,	 0,  LOG_NORMAL, 1, false, "TIME WEATHER" },
    { "version",	do_showversion,	POS_DEAD,	 0,  LOG_NORMAL, 1, true },
    { "war",		do_war,		POS_STANDING,	 0,  LOG_NORMAL, 1, false },
    { "weather",	do_weather,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "TIME WEATHER" },
    { "who",		do_who_new,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "WHERE WHO WHOIS" },
    { "whois",		do_whois,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "WHERE WHO WHOIS" },
    { "wizlist",	do_wizlist,	POS_DEAD,        0,  LOG_NORMAL, 1, true, "WIZLIST IMMORTALS" },

    // Configuration commands
    { "alias",		do_alias,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "ALIAS UNALIAS" },

    { "autolist",	do_toggle,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "TOGGLE" },
    { "colour",		do_colour,	POS_DEAD,        0,  LOG_NORMAL, 1, true, "COLOR COLOUR"},
    { "color",		do_colour,      POS_DEAD,        0,  LOG_NORMAL, 1, true, "COLOR COLOUR"},
    { "config",	        do_toggle,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "TOGGLE" },
    { "description",	do_description,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "DESCRIPTION TITLE" },
    { "delet",			do_delet,	POS_DEAD,	 0,  LOG_ALWAYS, 0, false },
    { "delete",			do_delete,	POS_STANDING,	 0,  LOG_ALWAYS, 1, false },
    { "email",			do_email,	POS_DEAD,	 0,  LOG_ALWAYS, 1, true, "EMAIL" },
    { "password",		do_password,	POS_DEAD,	 0,  LOG_ALWAYS, 1, true, "PASSWORD" },
    { "prompt",			do_prompt,	POS_DEAD,        0,  LOG_NORMAL, 1, true, "PROMPT" },
    { "showdamage",		do_showdamage,	POS_DEAD,	 0,  LOG_NORMAL, 1, true },
    { "scroll",			do_scroll,	POS_DEAD,	 0,  LOG_NORMAL, 1, true },
    { "title",			do_title,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "DESCRIPTION TITLE" },
    { "toggle",			do_toggle,	POS_DEAD,	 0,  LOG_NORMAL, 0, true, "TOGGLE" },
    { "unalias",		do_unalias,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "ALIAS UNALIAS" },
    { "wimpy",			do_wimpy,	POS_DEAD,	 0,  LOG_NORMAL, 1, true, "WIMPY" },

    // Communication commands
    { "afk",			do_afk,		POS_SLEEPING,	 0,  LOG_NORMAL, 1, true, "AFK AWAY" },
    { "announcements",  do_announcements, POS_SLEEPING,  0,  LOG_NORMAL, 1, true, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "catchup",		do_catchup,	POS_DEAD,	 0,  LOG_NORMAL, 1, true },
    { "chat",			do_chat,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "CHAT" },
    { "/",				do_chat,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "CHAT" },
    { ",",				do_emote,	POS_RESTING,	 0,  LOG_NEVER,  0, false, "EMOTE" },
    { ".",				do_gossip,	POS_SLEEPING,	 0,  LOG_NORMAL, 0, true, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { ";",				do_gtell,	POS_DEAD,	 0,  LOG_NEVER,  0, false, "FTALK GTALK" },
    { "'",				do_say,		POS_RESTING,	 0,  LOG_NEVER,  0, false, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "emote",			do_emote,	POS_RESTING,	 0,  LOG_NEVER,  1, false, "EMOTE" },
    { "flame",			do_flame,	POS_RESTING,	 0,  LOG_NORMAL, 1, true, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "formstate",		do_formstate,   POS_SLEEPING,	 0,  LOG_NORMAL, 1, false, "AUTO BATTLESPAM CHALLENGE NOSUMMON NOFOL FORMSTATE NORESURRECT" },
    { "gossip",			do_gossip,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, true, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "gtell",			do_gtell,	POS_DEAD,	 0,  LOG_NEVER,  1, true, "FTALK GTALK" },
    { "helper",			do_helper, 	POS_SLEEPING,	 0,  LOG_NORMAL, 1, true, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    ...
    { "note",			do_note,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, true, "NOTES" },
    { "notify",			do_notify,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, false },
    { "ooc",			do_ooc,		POS_SLEEPING,	 0,  LOG_NORMAL, 1, true, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "pursuit",		do_pursuit,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, false, "PURSUIT" },
    { "qlist",			do_qlist,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, true },
    { "quiet",			do_quiet,	POS_SLEEPING, 	 0,  LOG_NORMAL, 1, true },
    { "quote",			do_quote,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, true, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "replay",			do_replay,	POS_SLEEPING,	 0,  LOG_NEVER,  1, true },
    { "say",			do_say,		POS_RESTING,	 0,  LOG_NEVER,  1, false, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "sayto",			do_sayto,	POS_RESTING,	 0,  LOG_NEVER,  1, false, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },	// NIB : 20070121
    { "unread",			do_unread,	POS_SLEEPING,    0,  LOG_NORMAL, 1, false, "NOTES" },
    { "whisper",		do_whisper,	POS_RESTING,	 0,  LOG_NEVER,  1, false, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },
    { "yell",			do_yell,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "CHANNELS TELL SHOUT YELL GOSSIP OOC SAY" },

    // Object manipulation commands
	{ "activate",		do_activate,	POS_RESTING, 0, LOG_NORMAL, 1, false },
    { "bind",			do_bind,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "BINDING" },
    { "blow",			do_blow,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "brandish",		do_brandish,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "RECITE QUAFF ZAP BRANDISH" },
    { "brew",			do_brew,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "BREW" },
    { "close",			do_close,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "OPEN CLOSE" },
    { "combine",		do_combine,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "COMBINE" },
	{ "deactivate",		do_activate,	POS_RESTING, 0, LOG_NORMAL, 1, false },
    { "deposit",		do_deposit,	POS_RESTING,	 0,  LOG_ALWAYS, 1, false },
    { "drink",			do_drink,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "EAT DRINK FILL POUR" },
    { "drop",			do_drop,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "eat",			do_eat,		POS_RESTING,	 0,  LOG_NORMAL, 1, false, "EAT DRINK FILL POUR" },
    { "envenom",		do_envenom,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "ENVENOM" },
    { "fill",			do_fill,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "EAT DRINK FILL POUR" },
    { "give",			do_give,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "DROP GIVE" },
    { "hands",			do_hands,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "HEALING HANDS" },
    { "heal",			do_heal,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "HEALER" },
    { "hold",			do_wear,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "WEAR WIELD HOLD SECONDARY" },
    { "infuse",			do_infuse,	POS_DEAD,	 0,  LOG_ALWAYS, 1, false, "INFUSE" },
    { "inspect", 		do_inspect,     POS_RESTING,	 0,  LOG_NORMAL, 1, false, "SHOPS LIST BUY SELL INSPECT VALUE" },
    { "keep",			do_keep,	POS_RESTING,     0,  LOG_NORMAL, 1, true, "KEEP" },
    { "knock",			do_knock,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "list",			do_list,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "SHOPS LIST BUY SELL INSPECT VALUE" },
    { "lock",			do_lock,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "LOCK UNLOCK" },
    { "locker",			do_locker,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "LOCKERS" },
    { "lore",			do_lore,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "LORE" },
    { "mail",			do_mail,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "MAIL" },
    { "open",			do_open,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "OPEN CLOSE" },
    { "pick",			do_pick,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "PICK LOCK" },
    { "plant",			do_plant,	POS_SLEEPING,	 0,  LOG_NORMAL, 1, false },
    { "pour",			do_pour,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "EAT DRINK FILL POUR" },
    { "put",			do_put,		POS_RESTING,	 0,  LOG_NORMAL, 1, false, "GET PUT TAKE" },
    { "quaff",			do_quaff,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "RECITE QUAFF ZAP BRANDISH" },
    { "recite",			do_recite,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "RECITE QUAFF ZAP BRANDISH" },
    { "remove",			do_remove,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "restring",       do_restring,    POS_RESTING, 	 0,  LOG_ALWAYS, 1, false, "RESTRING" },
    { "sacrifice",		do_sacrifice,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "SACRIFICE" },
    { "scribe",			do_scribe,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "SCRIBE" },
    { "sell",			do_sell,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "SHOPS LIST BUY SELL INSPECT VALUE" },
    { "skull",			do_skull,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "SKULL" },
    { "strike",			do_strike,	POS_RESTING,	 0,  LOG_NORMAL, 1, false },
    { "take",			do_get,		POS_RESTING,	 0,  LOG_NORMAL, 1, false, "GET PUT TAKE" },
    { "unrestring",		do_unrestring,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "RESTRING" },
    { "value",			do_value,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "SHOPS LIST BUY SELL INSPECT VALUE" },
    { "wear",			do_wear,	POS_RESTING,	 0,  LOG_NORMAL, 1, false, "WEAR WIELD HOLD SECONDARY" },
    { "zap",			do_zap,		POS_RESTING,	 0,  LOG_NORMAL, 1, false, "RECITE QUAFF ZAP BRANDISH" },
    ...
    { "consume", 	do_consume, 	POS_DEAD,	 0,  LOG_NORMAL, 1, false, "CONSUME" },
    { "feed",		do_bite, 	POS_DEAD,	 0,  LOG_NORMAL, 1, false },
    { "shape",  	do_shape, 	POS_DEAD,	 0,  LOG_NORMAL, 1, false, "SHAPE" },
    { "shift",		do_shift, 	POS_DEAD,	 0,  LOG_NORMAL, 1, false },
    { "toxins",		do_toxins,	POS_DEAD,	 0,  LOG_NORMAL, 1, false, "TOXINS" },
