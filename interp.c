...
{ "migratefiles",	do_migratefiles,	POS_DEAD,	ML,  LOG_ALWAYS, 1, true },
    ...
    { "racedit",	do_racedit,	POS_DEAD,    L5,  LOG_NORMAL, 1, true },
    { "rcopy",		do_rcopy,	POS_DEAD,    L5,  LOG_ALWAYS, 1, true },
    { "redit",		do_redit,	POS_DEAD,    L5,  LOG_NORMAL, 1, true },
    { "rsgedit",	do_rsgedit,	POS_DEAD,    L5,  LOG_NORMAL, 1, true },
    ...
    { "skedit",		do_skedit,	POS_DEAD,    L5,  LOG_NORMAL, 1, true },
    { "soedit",		do_soedit,	POS_DEAD,    L5,  LOG_NORMAL, 1, true },
