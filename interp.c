...
const	struct	cmd_type	cmd_table	[] =
{
	...
	{ "dlgedit",			CMDTYPE_OLC,		do_dlgedit,				POS_DEAD,		STAFF_IMPLEMENTOR,	LOG_NORMAL, true,	true },
	{ "dlglist",			CMDTYPE_OLC,		do_dlglist,				POS_DEAD,		STAFF_IMPLEMENTOR,	LOG_NORMAL, true,	true },
	{ "dlgshow",			CMDTYPE_OLC,		do_dlgshow,				POS_DEAD,		STAFF_IMPLEMENTOR,	LOG_NORMAL, true,	true },
