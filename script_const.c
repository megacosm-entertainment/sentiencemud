...
ENT_FIELD entity_types[] = {
    ...
    {"quest",             ENTITY_VAR_QUEST,             ENT_QUEST       },
    {"qstage",            ENTITY_VAR_QUEST_STAGE,       ENT_QUEST_STAGE },
    {"queststage",        ENTITY_VAR_QUEST_STAGE,       ENT_QUEST_STAGE },
    {"qobjective",        ENTITY_VAR_QUEST_OBJECTIVE,   ENT_QUEST_OBJECTIVE },
    {"objective",         ENTITY_VAR_QUEST_OBJECTIVE,   ENT_QUEST_OBJECTIVE },
    {"questobjective",    ENTITY_VAR_QUEST_OBJECTIVE,   ENT_QUEST_OBJECTIVE },
...
ENT_FIELD entity_string[] = {
    ...
    {"padleft",	ENTITY_STR_PADLEFT,	ENT_STRING	},
    {"padright",	ENTITY_STR_PADRIGHT,	ENT_STRING	},
    {NULL,		0,			ENT_UNKNOWN	}
};
...
ENT_FIELD entity_mobile[] = {
    ...
    {"event_stage",     ENTITY_MOB_EVENT_STAGE,         ENT_STRING },
    {"event_stage_index", ENTITY_MOB_EVENT_STAGE_INDEX, ENT_NUMBER },
    {"event_stage_count", ENTITY_MOB_EVENT_STAGE_COUNT, ENT_NUMBER },
    {"event_objectives_met", ENTITY_MOB_EVENT_OBJECTIVES_MET, ENT_NUMBER },
    {"event_objectives_total", ENTITY_MOB_EVENT_OBJECTIVES_TOTAL, ENT_NUMBER },
    {"event_objective_progress", ENTITY_MOB_EVENT_OBJECTIVE_PROGRESS, ENT_NUMBER },
    {"event_completion", ENTITY_MOB_EVENT_COMPLETION,   ENT_NUMBER },
    {"event",           ENTITY_MOB_EVENT,               ENT_EVENT },
    {"events",          ENTITY_MOB_EVENTS,              ENT_ILLIST_EVENT },
...
ENT_FIELD entity_object[] = {
    ...
    {"isstached",   ENTITY_OBJ_ISSTACHED,   ENT_BOOLEAN },
        ...
        {"event_stage",     ENTITY_OBJ_EVENT_STAGE,           ENT_STRING },
        {"event_stage_index", ENTITY_OBJ_EVENT_STAGE_INDEX,   ENT_NUMBER },
        {"event_stage_count", ENTITY_OBJ_EVENT_STAGE_COUNT,   ENT_NUMBER },
        {"event_objectives_met", ENTITY_OBJ_EVENT_OBJECTIVES_MET, ENT_NUMBER },
        {"event_objectives_total", ENTITY_OBJ_EVENT_OBJECTIVES_TOTAL, ENT_NUMBER },
        {"event_objective_progress", ENTITY_OBJ_EVENT_OBJECTIVE_PROGRESS, ENT_NUMBER },
        {"event_completion", ENTITY_OBJ_EVENT_COMPLETION,     ENT_NUMBER },
        {"event",           ENTITY_OBJ_EVENT,                 ENT_EVENT },
        {"events",          ENTITY_OBJ_EVENTS,                ENT_ILLIST_EVENT },
...
ENT_FIELD entity_room[] = {
    ...
    {"sector",		ENTITY_ROOM_SECTOR,		ENT_SECTOR	},
    {"sectorflags",	ENTITY_ROOM_SECTORFLAGS,	ENT_BITVECTOR	},
    {"event",          ENTITY_ROOM_EVENT,            ENT_EVENT   },
    {"events",         ENTITY_ROOM_EVENTS,           ENT_ILLIST_EVENT },
    {NULL,			0,							ENT_UNKNOWN	}
};
...
ENT_FIELD entity_sector[] = {
    ...
    {"class",			ENTITY_SECTOR_CLASS,		ENT_NUMBER	},
    {"flags",			ENTITY_SECTOR_FLAGS,		ENT_BITVECTOR	},
    {"move_cost",		ENTITY_SECTOR_MOVE_COST,	ENT_NUMBER	},
    {"heal_rate",		ENTITY_SECTOR_HEAL_RATE,	ENT_NUMBER	},
    {"mana_rate",		ENTITY_SECTOR_MANA_RATE,	ENT_NUMBER	},
    {"move_rate",		ENTITY_SECTOR_MOVE_RATE,	ENT_NUMBER	},
    {"soil",			ENTITY_SECTOR_SOIL,		ENT_NUMBER	},
    {"affinity1_catalyst", ENTITY_SECTOR_AFFINITY1_CATALYST, ENT_NUMBER},
    {"affinity1_value", ENTITY_SECTOR_AFFINITY1_VALUE, ENT_NUMBER},
    {"affinity2_catalyst", ENTITY_SECTOR_AFFINITY2_CATALYST, ENT_NUMBER},
    {"affinity2_value", ENTITY_SECTOR_AFFINITY2_VALUE, ENT_NUMBER},
...
ENT_FIELD entity_event[] = {
    ...
    {"stage",                   ENTITY_EVENT_STAGE,             ENT_STRING },
    {"event_stage",             ENTITY_EVENT_STAGE,             ENT_STRING },
    {"stage_index",             ENTITY_EVENT_STAGE_INDEX,       ENT_NUMBER },
    {"event_stage_index",       ENTITY_EVENT_STAGE_INDEX,       ENT_NUMBER },
    {"stage_count",             ENTITY_EVENT_STAGE_COUNT,       ENT_NUMBER },
    {"event_stage_count",       ENTITY_EVENT_STAGE_COUNT,       ENT_NUMBER },
    {"objectives_met",          ENTITY_EVENT_OBJECTIVES_MET,    ENT_NUMBER },
    {"event_objectives_met",    ENTITY_EVENT_OBJECTIVES_MET,    ENT_NUMBER },
    {"objectives_total",        ENTITY_EVENT_OBJECTIVES_TOTAL,  ENT_NUMBER },
    {"event_objectives_total",  ENTITY_EVENT_OBJECTIVES_TOTAL,  ENT_NUMBER },
    {"objective_progress",      ENTITY_EVENT_OBJECTIVE_PROGRESS, ENT_NUMBER },
    {"event_objective_progress", ENTITY_EVENT_OBJECTIVE_PROGRESS, ENT_NUMBER },
    {"completion",              ENTITY_EVENT_COMPLETION,        ENT_NUMBER },
    {"event_completion",        ENTITY_EVENT_COMPLETION,        ENT_NUMBER },
    {NULL,                       0,                              ENT_UNKNOWN }
};
...
ENT_FIELD entity_area[] = {
    ...
    {"event",   ENTITY_AREA_EVENT,   ENT_EVENT   },
    {"events",  ENTITY_AREA_EVENTS,  ENT_ILLIST_EVENT },
    {NULL,		0,			ENT_UNKNOWN	}
};
...
//	{"quest",			ENTITY_INSTANCE_QUEST,			ENT_QUEST			},
    ...
    {"event",          ENTITY_INSTANCE_EVENT,       ENT_EVENT },
    {"events",         ENTITY_INSTANCE_EVENTS,      ENT_ILLIST_EVENT },
    {NULL,				0,								ENT_UNKNOWN			}
};
...
ENT_FIELD entity_dungeon[] = {
    ...
    {"event",          ENTITY_DUNGEON_EVENT,        ENT_EVENT },
    {"events",         ENTITY_DUNGEON_EVENTS,       ENT_ILLIST_EVENT },
    {NULL,				0,								ENT_UNKNOWN			}
};
...
ENT_FIELD entity_quest[] = {
    {"id",                ENTITY_QUEST_RUNID,             ENT_NUMBER      },
    {"runid",             ENTITY_QUEST_RUNID,             ENT_NUMBER      },
    {"status",            ENTITY_QUEST_STATUS,            ENT_NUMBER      },
    {"active",            ENTITY_QUEST_ACTIVE,            ENT_BOOLEAN     },
    {"completed",         ENTITY_QUEST_COMPLETED,         ENT_BOOLEAN     },
    {"failed",            ENTITY_QUEST_FAILED,            ENT_BOOLEAN     },
    {"abandoned",         ENTITY_QUEST_ABANDONED,         ENT_BOOLEAN     },
    {"scope",             ENTITY_QUEST_SCOPE,             ENT_NUMBER      },
    {"index",             ENTITY_QUEST_INDEX,             ENT_WIDEVNUM    },
    {"wnum",              ENTITY_QUEST_INDEX,             ENT_WIDEVNUM    },
    {"name",              ENTITY_QUEST_NAME,              ENT_STRING      },
    {"description",       ENTITY_QUEST_DESCRIPTION,       ENT_STRING      },
    {"stage",             ENTITY_QUEST_STAGE,             ENT_NUMBER      },
    {"stageid",           ENTITY_QUEST_STAGE,             ENT_NUMBER      },
    {"current_stage",     ENTITY_QUEST_CURRENT_STAGE,     ENT_QUEST_STAGE },
    {"stages",            ENTITY_QUEST_STAGES,            ENT_ILLIST_QUEST_STAGES },
    {"stage_objectives",  ENTITY_QUEST_OBJECTIVES,        ENT_ILLIST_QUEST_OBJECTIVES },
    {"objectivelist",     ENTITY_QUEST_OBJECTIVES,        ENT_ILLIST_QUEST_OBJECTIVES },
    {"stage_commenced",   ENTITY_QUEST_STAGE_COMMENCED,   ENT_BOOLEAN     },
    {"stagecomplete",     ENTITY_QUEST_STAGE_COMPLETE,    ENT_BOOLEAN     },
    {"objective_count",   ENTITY_QUEST_OBJECTIVE_COUNT,   ENT_NUMBER      },
    {"objectives",        ENTITY_QUEST_OBJECTIVE_COUNT,   ENT_NUMBER      },
    {"part_count",        ENTITY_QUEST_PART_COUNT,        ENT_NUMBER      },
    {"parts",             ENTITY_QUEST_PART_COUNT,        ENT_NUMBER      },
    {"generating",        ENTITY_QUEST_GENERATING,        ENT_BOOLEAN     },
    {"scripted",          ENTITY_QUEST_SCRIPTED,          ENT_BOOLEAN     },
    {NULL,                 0,                              ENT_UNKNOWN     }
};
...
ENT_FIELD entity_quest_stage[] = {
    ...
    {"summary",           ENTITY_QUEST_STAGE_SUMMARY,           ENT_STRING      },
    {"description",       ENTITY_QUEST_STAGE_DESCRIPTION,       ENT_STRING      },
    {"source",            ENTITY_QUEST_STAGE_SOURCE,            ENT_NUMBER      },
    {"autocommence",      ENTITY_QUEST_STAGE_AUTOCOMMENCE,      ENT_BOOLEAN     },
    {"completion",        ENTITY_QUEST_STAGE_COMPLETION_MODE,   ENT_NUMBER      },
    {"next",              ENTITY_QUEST_STAGE_NEXT_STAGE,        ENT_NUMBER      },
    {"objectives",        ENTITY_QUEST_STAGE_OBJECTIVES,        ENT_ILLIST_QUEST_OBJECTIVES },
    {"objective_count",   ENTITY_QUEST_STAGE_OBJECTIVE_COUNT,   ENT_NUMBER      },
    {"commenced",         ENTITY_QUEST_STAGE_RUNTIME_COMMENCED, ENT_BOOLEAN     },
    {"complete",          ENTITY_QUEST_STAGE_RUNTIME_COMPLETE,  ENT_BOOLEAN     },
    {NULL,                 0,                                     ENT_UNKNOWN     }
};

ENT_FIELD entity_quest_objective[] = {
    {"id",                ENTITY_QUEST_OBJECTIVE_ID,              ENT_NUMBER      },
    {"type",              ENTITY_QUEST_OBJECTIVE_TYPE,            ENT_NUMBER      },
    {"summary",           ENTITY_QUEST_OBJECTIVE_SUMMARY,         ENT_STRING      },
    {"description",       ENTITY_QUEST_OBJECTIVE_DESCRIPTION,     ENT_STRING      },
    {"optional",          ENTITY_QUEST_OBJECTIVE_OPTIONAL,        ENT_BOOLEAN     },
    {"strict",            ENTITY_QUEST_OBJECTIVE_STRICT,          ENT_BOOLEAN     },
    {"required",          ENTITY_QUEST_OBJECTIVE_REQUIRED,        ENT_NUMBER      },
    {"quantity",          ENTITY_QUEST_OBJECTIVE_QUANTITY,        ENT_NUMBER      },
    {"mode",              ENTITY_QUEST_OBJECTIVE_TARGET_MODE,     ENT_NUMBER      },
    {"target",            ENTITY_QUEST_OBJECTIVE_TARGET,          ENT_WIDEVNUM    },
    {"target_tag",        ENTITY_QUEST_OBJECTIVE_TARGET_TAG,      ENT_STRING      },
    {"destination",       ENTITY_QUEST_OBJECTIVE_DESTINATION,     ENT_WIDEVNUM    },
    {"destination_tag",   ENTITY_QUEST_OBJECTIVE_DESTINATION_TAG, ENT_STRING      },
    {"progress",          ENTITY_QUEST_OBJECTIVE_PROGRESS,        ENT_NUMBER      },
    {"complete",          ENTITY_QUEST_OBJECTIVE_COMPLETE,        ENT_BOOLEAN     },
    {NULL,                 0,                                       ENT_UNKNOWN     }
};
...
//	name,					alias, 		type,					slot,			mob?,	obj?,	room?,	token?, area?, instance?, dungeon?, quest?, event?
{	"act",	NULL,	TRIG_ACT,	TRIGSLOT_ACTION,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"afterdeath",	NULL,	TRIG_AFTERDEATH,	TRIGSLOT_REPOP,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"afterkill",	NULL,	TRIG_AFTERKILL,	TRIGSLOT_FIGHT,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"animate",	NULL,	TRIG_ANIMATE,	TRIGSLOT_ANIMATE,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"assist",	NULL,	TRIG_ASSIST,	TRIGSLOT_FIGHT,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack",	NULL,	TRIG_ATTACK,	TRIGSLOT_FIGHT,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_backstab",	NULL,	TRIG_ATTACK_BACKSTAB,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_bash",	NULL,	TRIG_ATTACK_BASH,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_behead",	NULL,	TRIG_ATTACK_BEHEAD,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_bite",	NULL,	TRIG_ATTACK_BITE,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_blackjack",	NULL,	TRIG_ATTACK_BLACKJACK,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_circle",	NULL,	TRIG_ATTACK_CIRCLE,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_counter",	NULL,	TRIG_ATTACK_COUNTER,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_cripple",	NULL,	TRIG_ATTACK_CRIPPLE,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_dirtkick",	NULL,	TRIG_ATTACK_DIRTKICK,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_disarm",	NULL,	TRIG_ATTACK_DISARM,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_intimidate",	NULL,	TRIG_ATTACK_INTIMIDATE,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_kick",	NULL,	TRIG_ATTACK_KICK,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_rend",	NULL,	TRIG_ATTACK_REND,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_slit",	NULL,	TRIG_ATTACK_SLIT,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_smite",	NULL,	TRIG_ATTACK_SMITE,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_tailkick",	NULL,	TRIG_ATTACK_TAILKICK,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_trample",	NULL,	TRIG_ATTACK_TRAMPLE,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"attack_turn",	NULL,	TRIG_ATTACK_TURN,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"barrier",	NULL,	TRIG_BARRIER,	TRIGSLOT_ATTACKS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"blow",	NULL,	TRIG_BLOW,	TRIGSLOT_GENERAL,	false,	true,	false,	false,	false,	false,	false,	false,	false	},
{	"board",	NULL,	TRIG_BOARD,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"brandish",	NULL,	TRIG_BRANDISH,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"bribe",	NULL,	TRIG_BRIBE,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"bury",	NULL,	TRIG_BURY,	TRIGSLOT_GENERAL,	false,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"buy",	NULL,	TRIG_BUY,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"caninterrupt",	NULL,	TRIG_CANINTERRUPT,	TRIGSLOT_INTERRUPT,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"catalyst",	NULL,	TRIG_CATALYST,	TRIGSLOT_GENERAL,	false,	true,	false,	false,	false,	false,	false,	false,	false	},
{	"catalystfull",	NULL,	TRIG_CATALYST_FULL,	TRIGSLOT_GENERAL,	false,	true,	false,	false,	false,	false,	false,	false,	false	},
{	"catalystsrc",	NULL,	TRIG_CATALYST_SOURCE,	TRIGSLOT_GENERAL,	false,	true,	false,	false,	false,	false,	false,	false,	false	},
{	"check_buyer",	NULL,	TRIG_CHECK_BUYER,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"check_damage",	NULL,	TRIG_CHECK_DAMAGE,	TRIGSLOT_DAMAGE,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"clone_extract",	NULL,	TRIG_CLONE_EXTRACT,	TRIGSLOT_GENERAL,	false,	false,	true,	true,	false,	false,	false,	false,	false	},
{	"close",	NULL,	TRIG_CLOSE,	TRIGSLOT_GENERAL,	false,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"combatstyle",	NULL,	TRIG_COMBAT_STYLE,	TRIGSLOT_COMBATSTYLE,	false,	false,	false,	true,	false,	false,	false,	false,	false	},	// Only on tokens
{	"completed",	NULL,	TRIG_COMPLETED,	TRIGSLOT_REPOP,	false,	false,	false,	false,	false,	true,	true,	false,	false	},
{	"contract_complete",	NULL,	TRIG_CONTRACT_COMPLETE,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"custom_price",	NULL,	TRIG_CUSTOM_PRICE,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"damage",	NULL,	TRIG_DAMAGE,	TRIGSLOT_DAMAGE,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"death",	NULL,	TRIG_DEATH,	TRIGSLOT_REPOP,	true,	false,	true,	true,	false,	false,	false,	false,	false	},
{	"death_protection",	NULL,	TRIG_DEATH_PROTECTION,	TRIGSLOT_REPOP,	true,	false,	true,	true,	false,	false,	false,	false,	false	},
{	"death_timer",	NULL,	TRIG_DEATH_TIMER,	TRIGSLOT_REPOP,	true,	false,	true,	true,	false,	false,	false,	false,	false	},
{	"defense",	NULL,	TRIG_DEFENSE,	TRIGSLOT_COMBATSTYLE,	true,	false,	false,	true,	false,	false,	false,	false,	false	},	// Only on tokens
{	"delay",	NULL,	TRIG_DELAY,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"drink",	NULL,	TRIG_DRINK,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"drop",	NULL,	TRIG_DROP,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"dungeon_commenced",	NULL,	TRIG_DUNGEON_COMMENCED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	true,	false,	false	},
{	"dungeon_schematic",	NULL,	TRIG_DUNGEON_SCHEMATIC,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	true,	false,	false	},
{	"eat",	NULL,	TRIG_EAT,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"emote",	NULL,	TRIG_EMOTE,	TRIGSLOT_ACTION,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"emoteat",	NULL,	TRIG_EMOTEAT,	TRIGSLOT_ACTION,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"emoteself",	NULL,	TRIG_EMOTESELF,	TRIGSLOT_ACTION,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"entry",	NULL,	TRIG_ENTRY,	TRIGSLOT_MOVE,	true,	true,	true,	true,	false,	true,	true,	false,	false	},
{	"exall",	NULL,	TRIG_EXALL,	TRIGSLOT_MOVE,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"examine",	NULL,	TRIG_EXAMINE,	TRIGSLOT_GENERAL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"exit",	NULL,	TRIG_EXIT,	TRIGSLOT_MOVE,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"expire",	NULL,	TRIG_EXPIRE,	TRIGSLOT_REPOP,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"extract",	NULL,	TRIG_EXTRACT,	TRIGSLOT_REPOP,	true,	true,	true,	false,	false,	false,	false,	false,	false	},
{	"failed",	NULL,	TRIG_FAILED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	true,	true,	false,	false	},
{	"fight",	NULL,	TRIG_FIGHT,	TRIGSLOT_FIGHT,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"flee",	NULL,	TRIG_FLEE,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"forcedismount",	NULL,	TRIG_FORCEDISMOUNT,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"get",	NULL,	TRIG_GET,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"give",	NULL,	TRIG_GIVE,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"grall",	NULL,	TRIG_GRALL,	TRIGSLOT_MOVE,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"greet",	NULL,	TRIG_GREET,	TRIGSLOT_MOVE,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"grouped",	NULL,	TRIG_GROUPED,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"grow",	NULL,	TRIG_GROW,	TRIGSLOT_RANDOM,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"hidden",	NULL,	TRIG_HIDDEN,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"hide",	NULL,	TRIG_HIDE,	TRIGSLOT_GENERAL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"hit",	NULL,	TRIG_HIT,	TRIGSLOT_HITS,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"hitgain",	NULL,	TRIG_HITGAIN,	TRIGSLOT_RANDOM,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"hpcnt",	NULL,	TRIG_HPCNT,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"identify",	NULL,	TRIG_IDENTIFY,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"inspect",	NULL,	TRIG_INSPECT,	TRIGSLOT_GENERAL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"inspect_custom",	NULL,	TRIG_INSPECT_CUSTOM,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"interrupt",	NULL,	TRIG_INTERRUPT,	TRIGSLOT_INTERRUPT,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"kill",	NULL,	TRIG_KILL,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"knock",	NULL,	TRIG_KNOCK,	TRIGSLOT_GENERAL,	false,	false,	true,	true,	false,	false,	false,	false,	false	},
{	"knocking",	NULL,	TRIG_KNOCKING,	TRIGSLOT_GENERAL,	false,	false,	true,	true,	false,	false,	false,	false,	false	},
{	"land",	NULL,	TRIG_LAND,	TRIGSLOT_MOVE,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"level",	NULL,	TRIG_LEVEL,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"login",	NULL,	TRIG_LOGIN,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"lore",	NULL,	TRIG_LORE,	TRIGSLOT_GENERAL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"lorex",	NULL,	TRIG_LORE_EX,	TRIGSLOT_GENERAL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"managain",	NULL,	TRIG_MANAGAIN,	TRIGSLOT_RANDOM,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"moon",	NULL,	TRIG_MOON,	TRIGSLOT_GENERAL,	false,	false,	false,	true,	true,	false,	false,	false,	true	},
{	"mount",	NULL,	TRIG_MOUNT,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"move_char",	NULL,	TRIG_MOVE_CHAR,	TRIGSLOT_MOVE,	true,	false,	true,	true,	false,	false,	false,	false,	false	},
{	"movegain",	NULL,	TRIG_MOVEGAIN,	TRIGSLOT_RANDOM,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"multiclass",	NULL,	TRIG_MULTICLASS,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"open",	NULL,	TRIG_OPEN,	TRIGSLOT_GENERAL,	false,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"postquest",	NULL,	TRIG_POSTQUEST,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"practice",	NULL,	TRIG_PRACTICE,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"practicetoken",	NULL,	TRIG_PRACTICETOKEN,	TRIGSLOT_GENERAL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"preanimate",	NULL,	TRIG_PREANIMATE,	TRIGSLOT_REPOP,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"preassist",	NULL,	TRIG_PREASSIST,	TRIGSLOT_FIGHT,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prebite",	NULL,	TRIG_PREBITE,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"prebuy",	NULL,	TRIG_PREBUY,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prebuy_obj",	NULL,	TRIG_PREBUY_OBJ,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"precast",	NULL,	TRIG_PRECAST,	TRIGSLOT_GENERAL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"predeath",	NULL,	TRIG_PREDEATH,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"predismount",	NULL,	TRIG_PREDISMOUNT,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"predrink",	NULL,	TRIG_PREDRINK,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"predrop",	NULL,	TRIG_PREDROP,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"preeat",	NULL,	TRIG_PREEAT,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"preenter",	NULL,	TRIG_PREENTER,	TRIGSLOT_MOVE,	false,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"preflee",	NULL,	TRIG_PREFLEE,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"preget",	NULL,	TRIG_PREGET,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"prehide",	NULL,	TRIG_PREHIDE,	TRIGSLOT_GENERAL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"prehidein",	NULL,	TRIG_PREHIDE_IN,	TRIGSLOT_GENERAL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"prekill",	NULL,	TRIG_PREKILL,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"premount",	NULL,	TRIG_PREMOUNT,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prepractice",	NULL,	TRIG_PREPRACTICE,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prepracticeother",	NULL,	TRIG_PREPRACTICEOTHER,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prepracticethat",	NULL,	TRIG_PREPRACTICETHAT,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prepracticetoken",	NULL,	TRIG_PREPRACTICETOKEN,	TRIGSLOT_GENERAL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"preput",	NULL,	TRIG_PREPUT,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"prequest",	NULL,	TRIG_PREQUEST,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prerecall",	NULL,	TRIG_PRERECALL,	TRIGSLOT_GENERAL,	false,	false,	true,	true,	false,	false,	false,	false,	false	},
{	"prerecite",	NULL,	TRIG_PRERECITE,	TRIGSLOT_GENERAL,	false,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"prereckoning",	NULL,	TRIG_PRERECKONING,	TRIGSLOT_RANDOM,	true,	true,	true,	true,	true,	false,	false,	false,	true	},
{	"prerehearse",	NULL,	TRIG_PREREHEARSE,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"preremove",	NULL,	TRIG_PREREMOVE,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"prerenew",	NULL,	TRIG_PRERENEW,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prerest",	NULL,	TRIG_PREREST,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"preresurrect",	NULL,	TRIG_PRERESURRECT,	TRIGSLOT_REPOP,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"preround",	NULL,	TRIG_PREROUND,	TRIGSLOT_FIGHT,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"presell",	NULL,	TRIG_PRESELL,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"presit",	NULL,	TRIG_PRESIT,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"presleep",	NULL,	TRIG_PRESLEEP,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"prespell",	NULL,	TRIG_PRESPELL,	TRIGSLOT_SPELL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prestand",	NULL,	TRIG_PRESTAND,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"pretrain",	NULL,	TRIG_PRETRAIN,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"pretraintoken",	NULL,	TRIG_PRETRAINTOKEN,	TRIGSLOT_GENERAL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"prewake",	NULL,	TRIG_PREWAKE,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"prewear",	NULL,	TRIG_PREWEAR,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"prewimpy",	NULL,	TRIG_PREWIMPY,	TRIGSLOT_FIGHT,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"pull",	NULL,	TRIG_PULL,	TRIGSLOT_GENERAL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"pullon",	NULL,	TRIG_PULL_ON,	TRIGSLOT_GENERAL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"pulse",	NULL,	TRIG_PULSE,	TRIGSLOT_RANDOM,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"push",	NULL,	TRIG_PUSH,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"pushon",	NULL,	TRIG_PUSH_ON,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"put",	NULL,	TRIG_PUT,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"quest_cancel",	NULL,	TRIG_QUEST_CANCEL,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"quest_complete",	NULL,	TRIG_QUEST_COMPLETE,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"quest_incomplete",	NULL,	TRIG_QUEST_INCOMPLETE,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"quest_part",	NULL,	TRIG_QUEST_PART,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"quest_accepted",	"quest_accept",	TRIG_QUEST_ACCEPTED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"quest_completed",	NULL,	TRIG_QUEST_COMPLETED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"quest_failed",	NULL,	TRIG_QUEST_FAILED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"quest_focused",	NULL,	TRIG_QUEST_FOCUSED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"stage_commenced",	NULL,	TRIG_STAGE_COMMENCED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"stage_completed",	NULL,	TRIG_STAGE_COMPLETED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"stage_failed",	NULL,	TRIG_STAGE_FAILED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"stage_target_resolved",	NULL,	TRIG_STAGE_TARGET_RESOLVED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"stage_dest_resolved",	NULL,	TRIG_STAGE_DEST_RESOLVED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"objective_completed",	NULL,	TRIG_OBJECTIVE_COMPLETED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"objective_failed",	NULL,	TRIG_OBJECTIVE_FAILED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"objective_target_resolved",	NULL,	TRIG_OBJECTIVE_TARGET_RESOLVED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"objective_dest_resolved",	NULL,	TRIG_OBJECTIVE_DEST_RESOLVED,	TRIGSLOT_GENERAL,	false,	false,	false,	false,	false,	false,	false,	true,	false	},
{	"quit",	NULL,	TRIG_QUIT,	TRIGSLOT_GENERAL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"random",	NULL,	TRIG_RANDOM,	TRIGSLOT_RANDOM,	true,	true,	true,	true,	true,	true,	true,	false,	true	},
{	"recall",	NULL,	TRIG_RECALL,	TRIGSLOT_GENERAL,	false,	false,	true,	true,	false,	false,	false,	false,	false	},
{	"recite",	NULL,	TRIG_RECITE,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"reckoning",	NULL,	TRIG_RECKONING,	TRIGSLOT_RANDOM,	true,	true,	true,	true,	true,	false,	false,	false,	true	},
{	"regen",	NULL,	TRIG_REGEN,	TRIGSLOT_RANDOM,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"regen_hp",	NULL,	TRIG_REGEN_HP,	TRIGSLOT_RANDOM,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"regen_mana",	NULL,	TRIG_REGEN_MANA,	TRIGSLOT_RANDOM,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"regen_move",	NULL,	TRIG_REGEN_MOVE,	TRIGSLOT_RANDOM,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"remort",	NULL,	TRIG_REMORT,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"remove",	NULL,	TRIG_REMOVE,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"renew",	NULL,	TRIG_RENEW,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"renew_list",	NULL,	TRIG_RENEW_LIST,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"repop",	NULL,	TRIG_REPOP,	TRIGSLOT_REPOP,	true,	true,	false,	true,	false,	true,	true,	false,	false	},
{	"reset",	NULL,	TRIG_RESET,	TRIGSLOT_REPOP,	false,	false,	true,	true,	true,	true,	true,	false,	true	},
{	"rest",	NULL,	TRIG_REST,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"restocked",	NULL,	TRIG_RESTOCKED,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"restore",	NULL,	TRIG_RESTORE,	TRIGSLOT_REPOP,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"resurrect",	NULL,	TRIG_RESURRECT,	TRIGSLOT_REPOP,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"save",	NULL,	TRIG_SAVE,	TRIGSLOT_REPOP,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"sayto",	NULL,	TRIG_SAYTO,	TRIGSLOT_SPEECH,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"showcommands",	NULL,	TRIG_SHOWCOMMANDS,	TRIGSLOT_VERB,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"sit",	NULL,	TRIG_SIT,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"skill_berserk",	NULL,	TRIG_SKILL_BERSERK,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"skill_sneak",	NULL,	TRIG_SKILL_SNEAK,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"skill_warcry",	NULL,	TRIG_SKILL_WARCRY,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"sleep",	NULL,	TRIG_SLEEP,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"speech",	NULL,	TRIG_SPEECH,	TRIGSLOT_SPEECH,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"spell",	NULL,	TRIG_SPELL,	TRIGSLOT_SPELL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"spellbeat",	NULL,	TRIG_SPELLBEAT,	TRIGSLOT_SPELL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"spellcast",	NULL,	TRIG_SPELLCAST,	TRIGSLOT_SPELL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"spellinter",	NULL,	TRIG_SPELLINTER,	TRIGSLOT_SPELL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"spellpenetrate",	NULL,	TRIG_SPELLPENETRATE,	TRIGSLOT_SPELL,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"spellreflect",	NULL,	TRIG_SPELLREFLECT,	TRIGSLOT_SPELL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"spell_cure",	NULL,	TRIG_SPELL_CURE,	TRIGSLOT_SPELL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"spell_dispel",	NULL,	TRIG_SPELL_DISPEL,	TRIGSLOT_SPELL,	true,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"stand",	NULL,	TRIG_STAND,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"startcombat",	NULL,	TRIG_START_COMBAT,	TRIGSLOT_FIGHT,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"stripaffect",	NULL,	TRIG_STRIPAFFECT,	TRIGSLOT_REPOP,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"takeoff",	NULL,	TRIG_TAKEOFF,	TRIGSLOT_MOVE,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"throw",	NULL,	TRIG_THROW,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"tick",	NULL,	TRIG_TICK,	TRIGSLOT_RANDOM,	true,	true,	true,	true,	true,	true,	true,	false,	true	},
{	"token_given",	NULL,	TRIG_TOKEN_GIVEN,	TRIGSLOT_REPOP,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"token_removed",	NULL,	TRIG_TOKEN_REMOVED,	TRIGSLOT_REPOP,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"touch",	NULL,	TRIG_TOUCH,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"toxingain",	NULL,	TRIG_TOXINGAIN,	TRIGSLOT_RANDOM,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"turn",	NULL,	TRIG_TURN,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"turnon",	NULL,	TRIG_TURN_ON,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"ungrouped",	NULL,	TRIG_UNGROUPED,	TRIGSLOT_GENERAL,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"use",	NULL,	TRIG_USE,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"usewith",	NULL,	TRIG_USEWITH,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"verb",	NULL,	TRIG_VERB,	TRIGSLOT_VERB,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"verbself",	NULL,	TRIG_VERBSELF,	TRIGSLOT_VERB,	false,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"wake",	NULL,	TRIG_WAKE,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"weapon_blocked",	NULL,	TRIG_WEAPON_BLOCKED,	TRIGSLOT_ATTACKS,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"weapon_caught",	NULL,	TRIG_WEAPON_CAUGHT,	TRIGSLOT_ATTACKS,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"weapon_parried",	NULL,	TRIG_WEAPON_PARRIED,	TRIGSLOT_ATTACKS,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	"wear",	NULL,	TRIG_WEAR,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"whisper",	NULL,	TRIG_WHISPER,	TRIGSLOT_SPEECH,	true,	false,	false,	true,	false,	false,	false,	false,	false	},
{	"wimpy",	NULL,	TRIG_WIMPY,	TRIGSLOT_FIGHT,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"xpgain",	NULL,	TRIG_XPGAIN,	TRIGSLOT_GENERAL,	true,	true,	true,	true,	false,	false,	false,	false,	false	},
{	"zap",	NULL,	TRIG_ZAP,	TRIGSLOT_GENERAL,	false,	true,	false,	true,	false,	false,	false,	false,	false	},
{	NULL,					NULL,		0,						TRIGSLOT_GENERAL,		false,	false,	false,	false,	false,	false,	false,	false,	false	}
};
...
//	{ "inchurch",			IFC_ANY,	"EE",	false,	ifc_inchurch,			"ifcheck inchurch" },	// already possible with church
    ...
    { "isvaliditem",		IFC_ANY,	"EE",	false,	ifc_isvaliditem,		"ifcheck isvaliditem" },
