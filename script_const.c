...
{	"buy",					NULL,		TRIG_BUY,				TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
...
{	"check_buyer",			NULL,		TRIG_CHECK_BUYER,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
...
{	"contract_complete",	NULL,		TRIG_CONTRACT_COMPLETE,	TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"custom_price",			NULL,		TRIG_CUSTOM_PRICE,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
...
{	"inspect",				NULL,		TRIG_INSPECT,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
...
{	"move_char",			NULL,		TRIG_MOVE_CHAR,			TRIGSLOT_MOVE,		TRUE,	FALSE,	TRUE,	TRUE	},
...
{	"prebuy_obj",			NULL,		TRIG_PREBUY_OBJ,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
...
{	"prerecite",			NULL,		TRIG_PRERECITE,			TRIGSLOT_GENERAL,	FALSE,	TRUE,	TRUE,	TRUE	},
...
{	"prerenew",				NULL,		TRIG_PRERENEW,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
...
{	"quest_cancel",			NULL,		TRIG_QUEST_CANCEL,		TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"quest_complete",		NULL,		TRIG_QUEST_COMPLETE,	TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"quest_incomplete",		NULL,		TRIG_QUEST_INCOMPLETE,	TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
...
{	"renew",				NULL,		TRIG_RENEW,				TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"renew_list",			NULL,		TRIG_RENEW_LIST,		TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
{	"repop",				NULL,		TRIG_REPOP,				TRIGSLOT_REPOP,		TRUE,	TRUE,	FALSE,	TRUE	},
{	"rest",					NULL,		TRIG_REST,				TRIGSLOT_GENERAL,	TRUE,	TRUE,	TRUE,	TRUE	},
{	"restocked",			NULL,		TRIG_RESTOCKED,			TRIGSLOT_GENERAL,	TRUE,	FALSE,	FALSE,	TRUE	},
...
{	"token_given",			NULL,		TRIG_TOKEN_GIVEN,		TRIGSLOT_REPOP,		FALSE,	FALSE,	FALSE,	TRUE	},
{	"token_removed",		NULL,		TRIG_TOKEN_REMOVED,		TRIGSLOT_REPOP,		FALSE,	FALSE,	FALSE,	TRUE	},
