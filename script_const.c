...
ENT_FIELD entity_mobile[] = {
	...
	{"created",					ENTITY_MOB_CREATED,					ENT_NUMBER,  		"Mob (or player) creation timestamp"},
	{"created_delta",			ENTITY_MOB_CREATED_DELTA,			ENT_NUMBER,		  	"Seconds since creation"},
	{"created_human",			ENTITY_MOB_CREATED_HUMAN,			ENT_STRING,  		"Creation time (human readable)"},
	{"eq",						ENTITY_MOB_EQUIPMENT,				ENT_EQUIPMENT,		"Mob equipment"},
	...
	{"last_login",				ENTITY_MOB_LASTLOGIN,				ENT_NUMBER,			"Last login timestamp"},
	{"last_login_delta",		ENTITY_MOB_LASTLOGIN_DELTA, 		ENT_NUMBER,			"Seconds since last login"},
	{"last_login_human", 		ENTITY_MOB_LASTLOGIN_HUMAN,			ENT_STRING, 		"Last login time (human readable)"},
	{"last_logoff",				ENTITY_MOB_LASTLOGOFF,				ENT_NUMBER,			"Last logoff timestamp (overwritten on save)"},
	{"last_logoff_delta",		ENTITY_MOB_LASTLOGOFF_DELTA, 		ENT_NUMBER,			"Seconds since last logoff"},
	{"last_logoff_human", 		ENTITY_MOB_LASTLOGOFF_HUMAN,		ENT_STRING,			"Last logoff time (human readable)"},
	...
	{"played",					ENTITY_MOB_PLAYED,					ENT_NUMBER,			"Total played time in seconds"},
	...
	{"session_time",			ENTITY_MOB_SESSIONTIME,				ENT_NUMBER,  		"Current play session duration (in seconds)"},
...
ENT_FIELD entity_church[] = {
	...
	{"founder_login",	ENTITY_CHURCH_FOUNDER_LOGIN,	ENT_NUMBER,	"Founder login timestamp"},
	{"founder_login_human",	ENTITY_CHURCH_FOUNDER_LOGIN_HUMAN,	ENT_STRING,	"Founder last login time (human readable)"	},
