...
{	"entry",				NULL,		TRIG_ENTRY,				TRIGSLOT_MOVE,			TRUE,	TRUE,	TRUE,	TRUE,	FALSE,	FALSE,	FALSE	},
{	"exall",				NULL,		TRIG_EXALL,				TRIGSLOT_MOVE,			TRUE,	TRUE,	TRUE,	TRUE,	FALSE,	FALSE,	FALSE	},
{	"examine",				NULL,		TRIG_EXAMINE,			TRIGSLOT_GENERAL,		FALSE,	TRUE,	FALSE,	TRUE,	FALSE,	FALSE,	FALSE	},
...
{	"repop",				NULL,		TRIG_REPOP,				TRIGSLOT_REPOP,			TRUE,	TRUE,	FALSE,	TRUE,	TRUE,	TRUE,	TRUE	},
