...
#define DECL_IFC_FUN(x) bool x (SCRIPT_VARINFO *info, CHAR_DATA *mob,OBJ_DATA *obj,ROOM_INDEX_DATA *room, TOKEN_DATA *token,AREA_DATA *area,INSTANCE *instance,DUNGEON *dungeon,long *ret,int argc,SCRIPT_PARAM **argv)
...
enum ifcheck_enum {
	...
	CHK_AFFECTEDNAME,CHK_AFFECTEDSPELL,
	...
	CHK_HANDSFULL,
	CHK_HAS,
		CHK_HASCATALYST,CHK_HASCHURCH,CHK_HASCHECKPOINT,CHK_HASCLASS,
		CHK_HASENVIRONMENT,
		CHK_HASFACTION,
		CHK_HASPROMPT,
		CHK_HASQUEUE,
		...
		CHK_HASVLINK,
	CHK_HEALREGEN,CHK_HIRED,CHK_HITDAMAGE,CHK_HITDAMCLASS,CHK_HITDAMTYPE,
...
// Multi-typing
enum entity_object_ammo_enum {
	ENTITY_OBJ_AMMO_TYPE = ESCAPE_EXTRA,
	ENTITY_OBJ_AMMO_DAMAGE_TYPE,
	ENTITY_OBJ_AMMO_FLAGS,
	ENTITY_OBJ_AMMO_DAMAGE,
...
enum entity_obj_jewelry_enum {
	ENTITY_OBJ_JEWELRY_MAXMANA = ESCAPE_EXTRA,
	ENTITY_OBJ_JEWELRY_SPELLS,
};
...
enum entity_object_portal_enum {
	ENTITY_OBJ_PORTAL_NAME = ESCAPE_EXTRA,
	ENTITY_OBJ_PORTAL_SHORT,
	ENTITY_OBJ_PORTAL_FLAGS,
	ENTITY_OBJ_PORTAL_EXIT,
	ENTITY_OBJ_PORTAL_TYPE,
	ENTITY_OBJ_PORTAL_DESTINATION,
	ENTITY_OBJ_PORTAL_PARAM0,
	ENTITY_OBJ_PORTAL_PARAM1,
	ENTITY_OBJ_PORTAL_PARAM2,
...
enum entity_object_wand_enum {
	...
	ENTITY_OBJ_WAND_MAXMANA,
	ENTITY_OBJ_WAND_SPELLS,
};


enum entity_object_weapon_wnum {
	ENTITY_OBJ_WEAPON_CLASS = ESCAPE_EXTRA,
	ENTITY_OBJ_WEAPON_ATTACKS,
	ENTITY_OBJ_WEAPON_AMMO,
	ENTITY_OBJ_WEAPON_RANGE,
	ENTITY_OBJ_WEAPON_CHARGES,
	ENTITY_OBJ_WEAPON_MAXCHARGES,
	ENTITY_OBJ_WEAPON_COOLDOWN,
	ENTITY_OBJ_WEAPON_RECHARGE,
	ENTITY_OBJ_WEAPON_MAXMANA,
	ENTITY_OBJ_WEAPON_SPELLS,
};

enum entity_weapon_attack_point_enum {
	ENTITY_WEAPON_ATTACK_NAME = ESCAPE_EXTRA,
	ENTITY_WEAPON_ATTACK_SHORT,
	ENTITY_WEAPON_ATTACK_TYPE,
	ENTITY_WEAPON_ATTACK_FLAGS,
	ENTITY_WEAPON_ATTACK_DAMAGE,
};

enum entity_attack_type_enum {
	ENTITY_ATTACK_NAME = ESCAPE_EXTRA,
	ENTITY_ATTACK_NOUN,
	ENTITY_ATTACK_TYPE,
};
...
enum entity_token_enum {
	...
	ENTITY_TOKEN_SKILL,
	ENTITY_TOKEN_AFFECTS,
	ENTITY_TOKEN_REPUTATION,
};
...
enum entity_material_enum {
	...
	ENTITY_MATERIAL_CLASS,
	ENTITY_MATERIAL_FLAGS,
	ENTITY_MATERIAL_FLAMMABLE,
	ENTITY_MATERIAL_CORRODIBILITY,
...
struct script_parameter {
	...
	union {
		...
		struct {
			OBJ_DATA *obj;
			int type;
		} obj_type;			// Used by ENT_INK_TYPES, ENT_INSTRUMENT_RESERVOIRS, ENT_WEAPON_ATTACK
		struct {
			union {
				CHAR_DATA **mob;
				OBJ_DATA **obj;
...
bool variables_setsave_affect(ppVARIABLE list,char *name,AFFECT_DATA *aff, sent_bool save);
bool variables_setsave_area (ppVARIABLE list, char *name,AREA_DATA* a, sent_bool save);
bool variables_setsave_area_region (ppVARIABLE list, char *name,AREA_REGION* ar, sent_bool save);
bool variables_setsave_church (ppVARIABLE list, char *name,CHURCH_DATA* church, sent_bool save);
bool variables_setsave_exit(ppVARIABLE list,char *name,EXIT_DATA *e, sent_bool save);
bool variables_setsave_integer(ppVARIABLE list,char *name,int num, sent_bool save);
bool variables_setsave_mobile(ppVARIABLE list,char *name,CHAR_DATA *m, sent_bool save);
bool variables_setsave_object(ppVARIABLE list,char *name,OBJ_DATA *o, sent_bool save);
bool variables_setsave_room(ppVARIABLE list,char *name,ROOM_INDEX_DATA *r, sent_bool save);
...
bool variables_setsave_token(ppVARIABLE list,char *name,TOKEN_DATA *t, sent_bool save);
bool variables_setsave_wilds (ppVARIABLE list, char *name,WILDS_DATA* wilds, sent_bool save);
bool variables_setsave_variable (ppVARIABLE list, char *name,pVARIABLE var, sent_bool save);
bool variables_setsave_dice (ppVARIABLE list, char *name,DICE_DATA *d, sent_bool save);
bool variables_setsave_boolean (ppVARIABLE list, char *name,bool boolean, sent_bool save);
bool variables_setsave_instance_section (ppVARIABLE list,char *name,INSTANCE_SECTION *section, sent_bool save);
bool variables_setsave_instance (ppVARIABLE list,char *name,INSTANCE *instance, sent_bool save);
bool variables_setsave_dungeon (ppVARIABLE list,char *name,DUNGEON *dungeon, sent_bool save);
bool variables_setsave_ship (ppVARIABLE list,char *name,SHIP_DATA *ship, sent_bool save);
...
bool variables_setsave_mobindex(ppVARIABLE list,char *name,MOB_INDEX_DATA *m, sent_bool save);
bool variables_setsave_objindex(ppVARIABLE list,char *name,OBJ_INDEX_DATA *o, sent_bool save);
bool variables_setsave_tokenindex(ppVARIABLE list,char *name,TOKEN_INDEX_DATA *t, sent_bool save);
bool variables_setsave_blueprint_section (ppVARIABLE list,char *name,BLUEPRINT_SECTION *section, sent_bool save);
bool variables_setsave_blueprint (ppVARIABLE list,char *name,BLUEPRINT *blueprint, sent_bool save);
bool variables_setsave_dungeonindex (ppVARIABLE list,char *name,DUNGEON_INDEX_DATA *dngindex, sent_bool save);
bool variables_setsave_shipindex (ppVARIABLE list,char *name,SHIP_INDEX_DATA *shipindex, sent_bool save);
bool variables_set_reputation (ppVARIABLE list,char *name,REPUTATION_DATA *reputation);
bool variables_setsave_reputation (ppVARIABLE list,char *name,REPUTATION_DATA *reputation, sent_bool save);
bool variables_set_reputation_index (ppVARIABLE list,char *name,REPUTATION_INDEX_DATA *reputation_index);
bool variables_setsave_reputation_index (ppVARIABLE list,char *name,REPUTATION_INDEX_DATA *reputation_index, sent_bool save);
bool variables_set_reputation_rank (ppVARIABLE list,char *name,REPUTATION_INDEX_RANK_DATA *reputation_rank);
bool variables_setsave_reputation_rank (ppVARIABLE list,char *name,REPUTATION_INDEX_RANK_DATA *reputation_rank, sent_bool save);
bool variables_set_race (ppVARIABLE list,char *name,RACE_DATA *race);
bool variables_setsave_race (ppVARIABLE list,char *name,RACE_DATA *race, sent_bool save);
bool variables_set_class (ppVARIABLE list,char *name,CLASS_DATA *clazz);
bool variables_setsave_class (ppVARIABLE list,char *name,CLASS_DATA *clazz, sent_bool save);
bool variables_set_classlevel (ppVARIABLE list,char *name,CLASS_LEVEL *level);
bool variables_setsave_classlevel (ppVARIABLE list,char *name,CLASS_LEVEL *level, sent_bool save);
