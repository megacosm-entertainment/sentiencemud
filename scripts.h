...
enum entity_widevnum_enum {
	ENTITY_WNUM_AREA = ESCAPE_EXTRA,
	ENTITY_WNUM_VNUM,
	ENTITY_WNUM_MOBINDEX,
	ENTITY_WNUM_OBJINDEX,
	ENTITY_WNUM_ROOM,
	ENTITY_WNUM_TOKENINDEX,
	ENTITY_WNUM_BLUEPRINT,
	ENTITY_WNUM_BLUEPRINT_SECTION,
	ENTITY_WNUM_DUNGEONINDEX,
	ENTITY_WNUM_SHIPINDEX,
};
