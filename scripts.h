...
enum ifcheck_enum {
    ...
    /* B */
    CHK_BANKBALANCE,CHK_BIT,CHK_BOOST,CHK_BOOSTTIMER,

    /* C */
    CHK_CANDROP,CHK_CANGET,CHK_CANHUNT,CHK_CANPRACTICE,CHK_CANPULL,CHK_CANPUT,
    ...
    /* D */
    CHK_DANGER,CHK_DAMTYPE,CHK_DAY,CHK_DEATH,CHK_DEATHCOUNT,CHK_DEITY,CHK_DICE,CHK_DRUNK,CHK_DUNGEONFLAG,
    ...
    CHK_PNEUMA,CHK_PORTAL,CHK_PORTALEXIT,CHK_POS,CHK_PRACTICES,CHK_PROTOCOL,
...
enum entity_mobile_enum {
    ...
    ENTITY_MOB_RACE,
    ENTITY_MOB_RACEDATA,
    ENTITY_MOB_ORIGINALRACE,
    ENTITY_MOB_ORIGINALRACEDATA,
    ENTITY_MOB_CLASS,
    ...
    ENTITY_MOB_LASTLOGIN,
    ENTITY_MOB_CREATED,
    ENTITY_MOB_PLAYED,
    ENTITY_MOB_SESSIONTIME,
    ENTITY_MOB_LASTLOGOFF_HUMAN,
    ENTITY_MOB_LASTLOGIN_HUMAN,
    ENTITY_MOB_CREATED_HUMAN,
...
enum entity_game_enum {
    ...
    ENTITY_GAME_RELIC_HEALTH,
    ENTITY_GAME_RELIC_MAGIC,
    
ENTITY_GAME_RESERVED_MOBILE,
ENTITY_GAME_RESERVED_OBJECT,
ENTITY_GAME_RESERVED_ROOM,
ENTITY_GAME_RESERVED_AREA,
ENTITY_GAME_RESERVED_TOKEN,
ENTITY_GAME_RESERVED_RPROG,
ENTITY_GAME_RESERVED_OPROG,
ENTITY_GAME_RESERVED_MPROG,
ENTITY_GAME_RESERVED_TPROG,
ENTITY_GAME_RESERVED_APROG,

ENTITY_GAME_SETTINGS,

    ENTITY_GAME_TIME_HUMAN,
};
...
enum entity_church_enum {
    ...
    ENTITY_CHURCH_FOUNDER_LOGIN,
    ENTITY_CHURCH_FOUNDER_LOGIN_HUMAN,
