...
const struct flag_type token_owner_types[] =
{
	{ "none",	TOKEN_OWNER_NONE,	false	},
	{ "mobile",	TOKEN_OWNER_MOB,	false	},
	{ "object",	TOKEN_OWNER_OBJ,	false	},
	{ "room",	TOKEN_OWNER_ROOM,	false	},
	{ NULL,		0,					false	}
};
