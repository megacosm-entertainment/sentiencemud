...
//         { "do_cargo",                   do_cargo },
         ...
         { "do_charge",                  do_charge },
         { "do_chat",                    do_chat },
         { "do_chbalance",                       do_chbalance },
         { "do_chcreate",                        do_chcreate },
         { "do_chdem",                   do_chdem },
         { "do_chgohall",                        do_chgohall },
         { "do_chlist",                  do_chlist },
         { "do_chprom",                  do_chprom },
         { "do_chrem",                   do_chrem },
         { "do_chtalk",                  do_chtalk },
