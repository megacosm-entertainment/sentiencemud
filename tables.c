...
const struct cmd_func_type cmd_func_table[] =
{
    // Any string that starts with _ cannot be set in cmdedit.
    // Channel system special function
    { "_do_speak_on_channel",        _do_speak_on_channel },
...
const struct flag_type report_reasons[] = {
    { "disturbing",     CHANNEL_REPORT_DISTURBING,      true },
    { "harassment",     CHANNEL_REPORT_HARASSMENT,      true },
    { "harmful",        CHANNEL_REPORT_HARMFUL,         true },
    { "hateful",        CHANNEL_REPORT_HATEFUL,         true },
    { "inappropriate",  CHANNEL_REPORT_INAPPROPRIATE,   true },
    { "none",           CHANNEL_REPORT_NONE,            false},
    { "sexual",         CHANNEL_REPORT_SEXUAL,          true },
    { "threatening",    CHANNEL_REPORT_THREATENING,     true },
    { NULL,             0,                              false}
};

const struct flag_type punishment_reasons[] = {
    { "banned",     PUNISHMENT_BANNED,      true },
    { "no_report",  PUNISHMENT_NO_REPORT,   true },
    { "none",       PUNISHMENT_NONE,        false},
    { "silenced",   PUNISHMENT_SILENCED,    true },
    { NULL,         0,                      false}
};

const struct flag_type channel_flags[] = {
    { "allow_banners",          CHANNEL_PLAYER_BANNER,          true },
    { "allow_colors",           CHANNEL_ALLOW_COLORS,           true },
    { "auto_join",              CHANNEL_AUTO_JOIN,              true },
    { "auto_join_staff",        CHANNEL_AUTO_JOIN_STAFF,        true },
    { "global_target",          CHANNEL_GLOBAL_TARGET,          true },
    { "inspected",              CHANNEL_INSPECTED,              false},
    { "needs_inspection",       CHANNEL_NEEDS_INSPECTION,       false},
    { "no_anon_broadcasts",     CHANNEL_NO_ANON_BROADCASTS,     true },
    { "player_moderated",       CHANNEL_PLAYER_MODERATED,       true },
    { "restricted",             CHANNEL_RESTRICTED,             true },
    { "targeted",               CHANNEL_TARGETED,               true },
    { NULL,                     0,                              false}
};

const struct flag_type channel_entry_flags[] = {
    { "allow_replay",           CHANNEL_ALLOW_REPLAY,   false},
    { "joined",                 CHANNEL_JOINED,         false},
    { NULL,                     0,                      false}
};
